...
// for(let i = 0 ; i < 4; i++){
//     if(userNames[i].includes('솔')) console.log(userNames[i])
// }
...
// for(let i = 0; i < 8; i++){
//     if( num.indexOf(numbers[i]) == -1 ) num.push(numbers[i])
// }
// console.log(num)
...
// num = products.indexOf(product)

// if( stock[num] < count ) console.log('재고가 부족합니다.')
// else {
//     console.log('구매 완료!')
//     stock[num] -= count
