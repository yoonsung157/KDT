...
public class Practice7 {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(p1.name + p1.species + p1.age);
        // System.out.println(p2.name + p2.species + p2.age);
        ...
        // r1.width = 10;
        // r1.height = 5;
        // System.out.print("사각형의 넓이: " + r1.width * r1.height);
        ...
        // if( p1.price > p2.price ){ System.out.println(p1.name); }
        ...
        // MenuItem list [] = {m1, m2, m3};
        
        // for(int i = 0; i < 3; i++){
        //     if(list[i].isSignature == true){
        //         System.out.printf("[대표메뉴]" + list[i].name + ": " + list[i].price + "원");
        //     }
        // }
        ...
        u1.name = scan.next(); u1.age = scan.nextInt(); u1.mbti = scan.next();
