...
public class Practice3 {
    public static void main(String[] args) {
        ...
        // System.out.print("국어 점수: "); int a = scan.nextInt();
        // System.out.print("영어 점수: "); int b = scan.nextInt();
        // System.out.print("수학 점수: "); int c = scan.nextInt();

        // int result1 = a + b + c;
        // double result2 = result1 / 3.0;

        // System.out.printf("총점: %d \n 평균: %.1f",result1, result2);
        ...
        // System.out.printf("원의 넓이: %f", result);
        ...
        // System.out.print("첫 번째 실수: "); double a = scan.nextDouble();
        // System.out.print("두 번째 실수: "); double b = scan.nextDouble();

        // double result = a / b * 100;
        // System.out.printf("비율: %.1f", result);
        ...
        // System.out.print("정수를 입력하세요: "); int a = scan.nextInt();
        // boolean b = true;
        // if(a % 2 == 0 ) { b = false; }
        // else { b = true; }
        // System.out.printf("결과: %b", b);
        ...
        // boolean b = false;
        // if(id.equals("admin") && pw.equals("1234") ) { b = true; }
        // System.out.printf("결과: %b", b);
        ...
        // System.out.print("1차 점수: "); int a = scan.nextInt();
        // System.out.print("1차 점수: "); int b = scan.nextInt();
        // System.out.println( a + b >= 150 ? "합격" : "불합격");
        ...
        */
        ...
        // System.out.print("밑변: "); double r = scan.nextDouble();
        // System.out.print("높이: "); double h = scan.nextDouble();

        // System.out.println(r * h / 2.0);
        ...
        // System.out.print("섭씨 온도: "); double a = scan.nextDouble();
